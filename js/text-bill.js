 ...
 function setTextTotals() {
     ...
     callTotalOne.innerHTML = totalEle({
         totalsCallBills: textBill.get().call
     })
     smsTotalOne.innerHTML = totalEle({
         totalsSmsBills: textBill.get().sms
     })
     // totalsBills = totalEle({totalsBills: textBill.get().total})
     // console.log(typeof totalsBills)
     totalOne.innerHTML = 'R' + totalEle({
         totalsBills: textBill.get().total
     })
 }
